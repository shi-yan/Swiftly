...
QCache<QString, StaticFileServer::FileCacheItem > StaticFileServer::m_fileCache(getAvailableSystemMemory() / 2048);
...
{
    return (m_fileContent.size() + m_fileGZipContent.size()) / 1024;
}
